    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "HotelierWebAPI V1");
                    c.RoutePrefix = string.Empty; // To serve the Swagger UI at the app's root (https://hoteliersweb.azurewebsites.net)
                });
